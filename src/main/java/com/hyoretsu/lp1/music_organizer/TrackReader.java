...
public class TrackReader {
 ...
 /**
  * Try to decode details of the artist and the title from the file name. It is
  * assumed that the details are in the form: artist-title.mp3
  *
 ...
 public ArrayList<Track> readTracks(String folder, String suffix) {
  ...
  ArrayList<Track> tracks = Arrays.stream(audioFiles).map(file -> decodeDetails(file))
