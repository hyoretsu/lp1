...
public class Canvas {
 ...
 public void setVisible(boolean visible) {
  if (graphic == null) {
   // first time: instantiate the offscreen image and fill it with the background
   // color
  ...
  */
 // Note: this is a slightly backwards way of maintaining the shape objects. It
 // is carefully designed to keep the visible shape interfaces in this project
 // clean and simple for educational purposes.
